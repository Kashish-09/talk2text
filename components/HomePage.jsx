...
export default function HomePage(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
            <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'>Talk 2
                <span className='text-orange-400 bold'> Text </span>
            </h1>
            <h3 className='font-medium md:text-lg'> Record  
                <span className='text-orange-400 p-2 md:text-lg'>
            ...
            <button onClick={recordingStatus === 'recording' ? stopRecording : startRecording} className='flex specialBtn px-4 py-2 rounded-xl items-center text-base justify-between gap-4 mx-auto w-72 max-w-full my-4'>
                ...
                <div className='flex items-center gap-2'>
                   ...
                   <i className={(recordingStatus === 'recording' ? 'fa-solid fa-microphone-slash  text-rose-300': 'fa-solid fa-microphone')}></i>
                </div>
            </button>
            <p className='text-base'>Or 
                <label className='text-orange-400 cursor-pointer hover:text-orange-700 duration-200 p-2 bold'>upload 
                    <input onChange={(e) => {
